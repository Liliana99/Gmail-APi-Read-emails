package com.crtlaltsupr.liliana.leeremails;
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        MakeRequestTask(GoogleAccountCredential credential) {
            ...
            mService = new com.google.api.services.gmail.Gmail.Builder(
                    ...
                    .setApplicationName("LeerPrioritarios")
                    .build();
        }
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            ListMessagesResponse response = mService.users().messages().list(user).setQ(q).execute();
            int contador = response.size();
            int contador2 = 1;
                ...
                if (readableMessage.getPayload() != null) {
                    for (MessagePartHeader header : readableMessage.getPayload().getHeaders()) {
                        if (header.getName().compareToIgnoreCase("Subject") == 0) {
                            ...
                            labels.add(contador2 + "- " + header.getValue());
                            contador2++;
        ...
        private void Mifilter()
        {
            ...
            Filter result = null;
            try {
                result = mService.users().settings().filters().create("me", filter).execute();
            } catch (IOException e) {
                e.printStackTrace();
            }
            if(result!=null)
            {
                System.out.println("Created filter " + result);
            }
